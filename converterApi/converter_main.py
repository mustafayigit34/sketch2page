...
from converterApi.compile_page import generate_form
...
def converter_run(test_image_path):
    ...
    detect.run(source=test_image_path, weights=weight_path, conf_thres=0.75, save_txt=True, save_conf=True,
